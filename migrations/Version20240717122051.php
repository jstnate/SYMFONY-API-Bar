 ...
 */
final class Version20240717122051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, serveur_id INT DEFAULT NULL, barman_id INT DEFAULT NULL, created_at DATETIME NOT NULL, table_number INT NOT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_F5299398B8F06499 (serveur_id), INDEX IDX_F5299398A1EB02C0 (barman_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
